...
SRC_URI = "file://licenses/GPL-2 \
		   ...
		   file://usr/share/myir/myir.bmp \
                   ...
                   file://usr/share/myir/myir_audio.mp3 \
                   file://usr/share/myir/myir_audio.wav \
		   file://hmi.service \
		   file://sw-version \
          "
...
do_install (){
	...
	install -m 755 ${WORKDIR}/etc/myir_test/myir_audio ${D}/etc/myir_test
	...
	install -m 755 ${WORKDIR}${datadir}/myir/myir_audio.mp3 ${D}${datadir}/myir/Music/myir_audio.mp3
	install -m 755 ${WORKDIR}${datadir}/myir/myir_audio.wav ${D}${datadir}/myir/Music/myir_audio.wav
